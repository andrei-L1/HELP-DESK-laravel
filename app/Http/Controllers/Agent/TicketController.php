...
class TicketController extends Controller
{
    ...
    public function store(StoreTicketRequest $request)
    {
        ...
        $year = date('Y');
        $ticket = Cache::lock('ticket_number_' . $year, 10)->block(5, function () use ($validated, $statusId, $priorityId, $departmentId, $assignedTo, $year) {
            return DB::transaction(function () use ($validated, $statusId, $priorityId, $departmentId, $assignedTo, $year) {
                $prefix   = 'TICKET-' . $year . '-';

    ...
    <AdminNavigation>
        ...
        <template #breadcrumbs>
            <div class="flex items-center gap-2 text-[11px] font-bold text-slate-500">
                ...
                <svg class="h-2 w-2 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" /></svg>
                <span class="text-slate-900 uppercase tracking-tighter">Registration Personnel Identity</span>
            </div>
        </template>
            ...
            <div class="max-w-4xl mx-auto space-y-10">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2 border-b border-slate-200">
                    <div class="space-y-4">
                        ...
                        <div>
                            <h1 class="text-4xl font-bold text-slate-900 tracking-tight">Create User</h1>
                            <p class="text-slate-500 text-sm mt-1 font-medium">Fill in the details below to add a new user to the system.</p>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-10">
                    ...
                    <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                        ...
                        <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-1.5">
                                ...
                                <input id="first_name" v-model="form.first_name" type="text" required placeholder="Enter first name"
                                    class="w-full bg-slate-50 border-slate-200 border rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:bg-white focus:border-indigo-500 transition-all outline-none shadow-inner" />
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input id="last_name" v-model="form.last_name" type="text" required placeholder="Enter last name"
                                    class="w-full bg-slate-50 border-slate-200 border rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:bg-white focus:border-indigo-500 transition-all outline-none shadow-inner" />
                    ...
                    <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden text-slate-900">
                        <div class="px-8 py-5 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                            <h2 class="text-xs font-black text-slate-900 uppercase tracking-widest">Authentication Framework</h2>
                            <svg class="w-5 h-5 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                        </div>
                        <div class="p-8 space-y-10">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-slate-900">
                                <div class="space-y-1.5">
                                    <label for="username" class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Username</label>
                                    <input id="username" v-model="form.username" type="text" required placeholder="e.g. jdoe"
                                        class="w-full bg-slate-50 border-slate-200 border rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:bg-white focus:border-indigo-500 transition-all outline-none shadow-inner" />
                                    <p v-if="form.errors.username" class="text-[10px] text-rose-500 font-bold mt-1.5 ml-1">{{ form.errors.username }}</p>
                                </div>
                                <div class="space-y-1.5">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-10 border-t border-slate-50">
                                <div class="space-y-1.5">
                                    <label for="password" class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Account Password</label>
                                    <input id="password" v-model="form.password" type="password" required placeholder="••••••••"
                                        class="w-full bg-slate-50 border-slate-200 border rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:bg-white focus:border-indigo-500 transition-all outline-none shadow-inner" />
                                    <p v-if="form.errors.password" class="text-[10px] text-rose-500 font-bold mt-1.5 ml-1">{{ form.errors.password }}</p>
                                </div>
                                <div class="space-y-1.5">
                                    ...
                                    <input id="password_confirmation" v-model="form.password_confirmation" type="password" required placeholder="••••••••"
                                        class="w-full bg-slate-50 border-slate-200 border rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:bg-white focus:border-indigo-500 transition-all outline-none shadow-inner" />
                                </div>
                            </div>
                        </div>

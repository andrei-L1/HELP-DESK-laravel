    ...
    <AdminNavigation>
        ...
        <template #breadcrumbs>
            <div class="flex items-center gap-2 text-[11px] font-bold text-slate-500">
                ...
                <svg class="h-2 w-2 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" /></svg>
                <span class="text-slate-900 uppercase tracking-widest">Assigned Cases</span>
            </div>
        </template>
        ...
        <div class="max-w-[1400px] mx-auto space-y-10 pb-20 pt-4">
                        ...
                        <div class="bg-white rounded-3xl shadow-2xl shadow-slate-900/20 w-full max-w-xl overflow-hidden border border-slate-100">
                            <div class="px-8 py-6 border-b border-slate-50 flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-[10px] font-bold text-slate-400 mt-0.5 uppercase tracking-widest italic tracking-tight italic tracking-tight">Add a new ticket to the system.</p>
                                </div>
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 px-4 stagger-1">
                <div class="space-y-1">
                    <h2 class="text-3xl font-black text-slate-900 tracking-tight">Assigned Tickets</h2>
                    <p class="text-slate-500 font-medium">Tracking and managing support requests specifically allocated to your handling.</p>
                </div>
                ...
                <div class="p-6 flex flex-col md:flex-row md:items-center gap-6">
                    <div class="flex-1 relative group">
                        ...
                        <input
                            ...
                            placeholder="Search among your assigned tickets..."
                        />
                    </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-slate-50/50 border-b border-slate-100">
                                ...
                                <th class="py-5 px-4 text-[10px] font-black text-slate-400 uppercase tracking-widest hidden md:table-cell text-center">Status</th>
                                <th class="py-5 px-4 text-[10px] font-black text-slate-400 uppercase tracking-widest hidden lg:table-cell text-center">Priority</th>
                                <th class="py-5 px-4 text-[10px] font-black text-slate-400 uppercase tracking-widest hidden sm:table-cell text-center">Initial Login</th>
                            ...
                            <tr>
                                <td colspan="6" class="py-40 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h4 class="text-xl font-black text-slate-900 tracking-tight">No Assigned Cases Found</h4>
                                        <p class="text-xs font-bold text-slate-400 mt-2 max-w-xs">There are currently no tickets assigned to you matching your criteria.</p>
                                        <button @click="resetFilters" class="mt-8 px-6 py-2.5 rounded-xl bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-slate-200">Reset View</button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
            ...
            <!-- Modern Pagination -->
            <div v-if="tickets.links && tickets.links.length > 3" class="flex flex-col sm:flex-row items-center justify-between px-4 py-8 stagger-5">

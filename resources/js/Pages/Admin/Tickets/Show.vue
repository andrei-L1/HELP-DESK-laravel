                            ...
                            <div class="border-t border-gray-100 flex flex-col bg-gray-50">
                                ...
                                <div class="flex px-6 pt-4 gap-2">
                                    <button 
                                        ...
                                        :class="!messageForm.is_internal ? 'bg-white border-slate-600 text-slate-800' : 'bg-transparent border-transparent text-gray-500 hover:bg-gray-200'"
                                    >
                                        Reply to Customer
                                    </button>
                                    <button 
                                        ...
                                        <textarea
                                            ...
                                            :class="[
                                                messageForm.is_internal 
                                                    ...
                                                    : 'border-gray-300 bg-white placeholder-gray-400 focus:border-slate-500 focus:ring-1 focus:ring-slate-500',
                                        ...
                                        <div class="flex items-center justify-end pt-2">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    :class="messageForm.is_internal ? 'bg-amber-600 hover:bg-amber-700' : 'bg-slate-700 hover:bg-slate-800'"

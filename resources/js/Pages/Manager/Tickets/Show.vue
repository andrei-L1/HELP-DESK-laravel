                            ...
                            <div class="border-t border-gray-100 flex flex-col bg-gray-50">
                                ...
                                <div class="flex px-6 pt-4 gap-2">
                                    <button 
                                        ...
                                        :class="!messageForm.is_internal ? 'bg-white border-indigo-600 text-indigo-800' : 'bg-transparent border-transparent text-gray-500 hover:bg-gray-200'"
                                    >
                                        Reply to Customer
                                    </button>
                                    <button 
                                    ...
                                    <form @submit.prevent="submitMessage" class="space-y-3">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div v-if="typingUser || internalTypingUser" class="text-xs animate-pulse font-medium">
                                                ...
                                                <span v-else-if="typingUser" class="text-indigo-600">{{ typingUser }} is typing...</span>
                                            </div>
                                        </div>
                                        <textarea
                                            id="message-body"
                                            ...
                                            :class="[
                                                messageForm.is_internal 
                                                    ...
                                                    : 'border-gray-300 bg-white placeholder-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500',
                                        ...
                                        <div class="flex items-center justify-end pt-2">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    :class="messageForm.is_internal ? 'bg-amber-600 hover:bg-amber-700' : 'bg-indigo-600 hover:bg-indigo-700'"

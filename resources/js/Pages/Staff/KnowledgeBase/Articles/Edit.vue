...
const form = useForm({
    ...
    is_internal: props.article.is_internal
});

const submit = () => {
    form.put(route('staff.kb.articles.update', props.article.id));
};
</script>
        ...
        <template #header-title>
            <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col">
                    <h1 class="text-xl font-black text-slate-900 tracking-tight">Edit Article</h1>
                </div>
            </div>
        </template>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input v-model="form.title" type="text" class="w-full rounded-xl border-slate-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition-colors" required />
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea v-model="form.excerpt" rows="2" class="w-full rounded-xl border-slate-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition-colors"></textarea>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea v-model="form.content" rows="12" class="w-full rounded-xl border-slate-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition-colors font-mono text-sm" required></textarea>

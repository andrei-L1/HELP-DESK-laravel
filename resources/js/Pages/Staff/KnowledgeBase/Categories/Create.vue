...
const submit = () => {
    form.post(route('staff.kb.categories.store'));
};
</script>
        ...
        <template #header-title>
            <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col">
                    <h1 class="text-xl font-black text-slate-900 tracking-tight">Create Category</h1>
                </div>
            </div>
        </template>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input v-model="form.name" type="text" class="w-full rounded-xl border-slate-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition-colors" placeholder="e.g. Getting Started" required />
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea v-model="form.description" rows="2" class="w-full rounded-xl border-slate-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition-colors" placeholder="Brief description of the category..."></textarea>
                    ...
                    <div class="space-y-2">
                        ...
                        <input v-model="form.icon" type="text" class="w-full rounded-xl border-slate-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition-colors font-mono text-sm" placeholder="<svg>...</svg> or 🚀" />

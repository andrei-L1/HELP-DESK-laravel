...
const navigation = [
    ...
    },
    {
        ...
        children: [
            { name: 'All Tickets', href: route('admin.tickets.all') },
    ...
    },
    {
        ...
        children: [
            { name: 'All Users', href: route('admin.users.all') },
            { name: 'User Roles', href: route('admin.users.roles') },
        ],
    },
    {
        name: 'Departments',
    ...
    },
    {
        ...
        children: [
            { name: 'General', href: route('admin.settings.general') },
            { name: 'Ticket Settings', href: route('admin.settings.ticket') },
            { name: 'Email Settings', href: route('admin.settings.email') },
            { name: 'SLA Policies', href: route('admin.settings.sla') },
        ],
    },
];
